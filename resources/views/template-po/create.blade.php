<x-layout>
    ...
    <div>
        <div class="flex items-center gap-2">
            ...
            <x-page-title>Buat Data Template PO</x-page-title>
        </div>
    </div>

    <div>
        <form onsubmit="return buatTemplateForm(event)" method="POST" action="/templateorder">
            @csrf
            @method('POST')
                ...
                <div class="w-full grid grid-cols-1 md:grid-cols-3 gap-2">
                    <div>
                        ...
                        <select id="suplier_id" name="suplier_id" style="width: 100%;" required
                            class="form-select select2 block w-full rounded-md border-0 py-2.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 text-xs leading-6">
                    ...
                    <div>
                        ...
                        <select id="gudang_id" name="gudang_id" style="width: 100%;" required
                            class="form-select select2 block w-full rounded-md border-0 py-2.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 text-xs leading-6">
            ...
            <div class="rounded-lg shadow-md p-4">
                <div class="mt-4 flex flex-col w-full gap-y-2 my-2 sm:col-span-3" id="input-area">
                    ...
                    <div class="grid w-full gird-cols-1 md:grid-cols-2 gap-2">
                        <div>
    ...
    <script>
        function buatTemplateForm(event) {
            event.preventDefault();

            konfirmasi = confirm('Buat data template PO?');
                ...
                <div class="mt-4" id="input-group">
                        ...
                        <div class="w-full border border-t border-[#099AA7]"></div>
                            ...
                            <div class="mt-2 grid grid-cols-1 md:grid-cols-2 gap-2">
                                ...
                                <div class="flex w-full mt-2 justify-end items-end">
