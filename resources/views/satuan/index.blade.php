<x-layout>
    ...
    <div>
        <x-page-title>List Satuan</x-page-title>

        <form action="/satuan" method="GET" class="my-6 flex flex-col md:flex-row gap-4 md:items-end"
            onchange="showLoadingModal()">
            @csrf
            @method('GET')

            <div>
                <label for="filterId" class="block text-xs font-medium leading-6 text-gray-900">Search By ID</label>
            ...
            <div>
                <label for="filterNama" class="block text-xs font-medium leading-6 text-gray-900">Search By Nama</label>
