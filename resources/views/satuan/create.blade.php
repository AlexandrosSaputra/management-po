<x-layout>
    ...
    <div>
        <div class="flex items-center gap-2">
            ...
            <x-page-title>Buat Data Satuan</x-page-title>
        </div>

        <div class="rounded-lg shadow-lg p-4">
            <form action="/satuan" method="POST" onsubmit="return buatSatuanForm(event)">
                @csrf
                @method('POST')
    ...
    <script>
        function buatSatuanForm(event) {
            event.preventDefault();

            konfirmasi = confirm('Buat data satuan?');
