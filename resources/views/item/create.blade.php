<x-layout>
    ...
    <div>
        <div class="flex items-center gap-2">
            ...
            <x-page-title>Buat Data Item</x-page-title>
        </div>

        <div class="rounded-lg shadow-lg p-4">
            <form action="/item" method="post" class="" onsubmit="return createItemForm(event)">
                @csrf
                @method('POST')
                ...
                <div class="w-full grid grid-cols-1 md:grid-cols-2 gap-2">
                    ...
                    <div>
                        ...
                        <select name="jenis_id" style="width: 100%;"
    ...
    <script>
        function createItemForm(event) {
            event.preventDefault();

            konfirmasi = confirm('Buat data item?');
