        ...
        <div class="relative bg-white rounded-lg shadow">
            ...
            <div class="p-4 md:p-5">
                ...
                <button type="submit" form="gudang-form" value="salah" name="salah"
                    onclick="submitGudangTidakSesuaiForm(event)"
                    class="w-full text-white bg-[#099AA7] hover:bg-[#099AA7]/80 focus:ring-4 focus:outline-none focus:ring-[#099AA7]/30 font-medium rounded-lg text-xs px-5 py-2.5 text-center ">Kirim</button>
            </div>
        </div>
    </div>
</div>
