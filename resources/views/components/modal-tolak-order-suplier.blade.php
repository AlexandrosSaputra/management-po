...
<!-- Main modal -->
<div id="modal-tolak-order-suplier" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow">
            ...
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t">
                ...
                <button type="button"
                    ...
                    data-modal-hide="modal-tolak-order-suplier">
            ...
            <div class="p-4 md:p-5">
                <form action="/order/{{ $order->id }}?token={{ $order->token }}" method="POST" id="tolak-form"
                    onsubmit="return suplierTolakOrderForm(event)">
                    @csrf
                    @method('PATCH')

                    <input type="text" value="ditolak" name="status" hidden />
                    <div class="mb-4">
